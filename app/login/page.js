  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (result?.error) {
        ...
        // SUCCESS: Redirect to Onboarding first
        router.refresh();
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#050505] p-6 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-zinc-500 mt-2 text-sm">Access your financial engine.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input 
                ...
                className="w-full bg-white/5 border border-white/10 rounded-xl py-4 pl-12 pr-4 text-white placeholder:text-zinc-700 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-transparent transition-all"
              />
            </div>
          </div>
          ...
          <button 
            disabled={loading}
            type="submit"
            className="w-full py-4 bg-white text-black font-bold rounded-xl hover:bg-zinc-200 transition-all active:scale-[0.98] mt-4 flex justify-center items-center gap-2"
          >
